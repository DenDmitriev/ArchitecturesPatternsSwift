...
class AsyncAlbumController: ASDKViewController<ASDisplayNode>, ASCollectionDelegate, ASCollectionDataSource {
    ...
    override init() {
        ...
        flowLayout.minimumLineSpacing = Size.Albom.seporator * 2
        flowLayout.minimumInteritemSpacing = Size.Albom.seporator
        collectionNode = ASCollectionNode(collectionViewLayout: flowLayout)
        collectionNode.backgroundColor = .systemBackground
        collectionNode.contentInset = UIEdgeInsets(top: Size.Albom.inset, left: Size.Albom.inset, bottom: Size.Albom.inset, right: Size.Albom.inset)
...
extension AsyncAlbumController: ASCollectionDelegateFlowLayout {
    ...
    func collectionNode(_ collectionNode: ASCollectionNode, constrainedSizeForItemAt indexPath: IndexPath) -> ASSizeRange {
        ...
        let width = (contentSizeWidth - ( (Size.Albom.itemsPerLine - 1) * Size.Albom.seporator)) / Size.Albom.itemsPerLine
