...
class AlbumsCollectionViewController: UICollectionViewController {
    ...
    private func setupCollectionView() {
        collectionView.contentInset = UIEdgeInsets(top: Size.Albom.seporator, left: Size.Albom.seporator, bottom: Size.Albom.seporator, right: Size.Albom.seporator)
...
extension AlbumsCollectionViewController: UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        ...
        let width = (collectionView.contentSize.width - Size.Albom.seporator) / 2
        
        return CGSize(width: width, height: width)
    }
    
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, insetForSectionAt section: Int) -> UIEdgeInsets {
        return UIEdgeInsets(top: Size.Albom.zero, left: Size.Albom.zero, bottom: Size.Albom.zero, right: Size.Albom.zero)
    }
    
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, minimumLineSpacingForSectionAt section: Int) -> CGFloat {
        return Size.Albom.seporator
    }
