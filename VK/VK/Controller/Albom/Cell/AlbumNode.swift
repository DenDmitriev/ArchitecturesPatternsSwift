...
class AlbumNode: ASCellNode {
    ...
    let thumbImageNode: ASNetworkImageNode = {
        ...
        node.cornerRadius = Size.Albom.cornerRadius
        return node
    }()
    ...
    init(album: Album) {
        ...
        let attributes = [
            ...
            NSAttributedString.Key.font: UIFont.systemFont(ofSize: Size.Albom.fontSize)
        ]
    ...
    override func layoutSpecThatFits(_ constrainedSize: ASSizeRange) -> ASLayoutSpec {
        ...
        let heightTitle = (Size.Albom.fontSize + (Size.Albom.seporator / 2))
