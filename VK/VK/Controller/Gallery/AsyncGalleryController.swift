...
class AsyncGalleryController: ASDKViewController<ASDisplayNode>, ASCollectionDelegate, ASCollectionDataSource {
    ...
    override init() {
        ...
        flowLayout.minimumLineSpacing = Size.Gallery.seporator
        flowLayout.minimumInteritemSpacing = Size.Gallery.seporator
        
        collectionNode = ASCollectionNode(collectionViewLayout: flowLayout)
        collectionNode.backgroundColor = .systemBackground
        collectionNode.contentInset = UIEdgeInsets(top: Size.Gallery.inset, left: Size.Gallery.inset, bottom: Size.Gallery.inset, right: Size.Gallery.inset)
...
extension AsyncGalleryController: ASCollectionDelegateFlowLayout {
    ...
    func collectionNode(_ collectionNode: ASCollectionNode, constrainedSizeForItemAt indexPath: IndexPath) -> ASSizeRange {
        ...
        let spaceWidth = contentSizeWidth - ((itemsPerLine - 1) * Size.Gallery.seporator)
